...
export type ProjectSite = "download" | "github" | "open";
...
const PROJECTS: Project[] = [
  // Board Resolution IS
  {
    ...
    links: [
      {
        site: "github",
        url: "https://github.com/christiankyle-ching/board_resolution_is",
      },
    ],
    media: [
      { url: img_boardResolutionIS_login, label: "" },
      { url: img_boardResolutionIS_certificate_view, label: "" },
      { url: img_boardResolutionIS_add_resolution, label: "" },
      { url: img_boardResolutionIS_resolutions, label: "" },
      { url: img_boardResolutionIS_backup_restore, label: "" },
      { url: img_boardResolutionIS_profile, label: "" },
      { url: img_boardResolutionIS_manage_users, label: "" },
      { url: img_boardResolutionIS_ocr, label: "" },
    ],
  },
  ...
  // John & Ruth Wedding
  {
    ...
    links: [{ site: "open", url: "https://john-ruth-wedding.web.app/" }],
    media: [
      { url: img_johnRuthWedding_introVideo, isVideo: true },
      { url: img_johnRuthWedding_gallery, label: "Photo Gallery" },
      { url: img_johnRuthWedding_find, label: "Guest: Find" },
      { url: img_johnRuthWedding_response, label: "Guest: Respond" },
      { url: img_johnRuthWedding_invitation, label: "Guest: Invitation" },
      { url: img_johnRuthWedding_login, label: "Admin: Login" },
      { url: img_johnRuthWedding_manage, label: "Admin: Manage Invitations" },
      { url: img_johnRuthWedding_edit, label: "Admin: Edit Invitation" },
      { url: img_johnRuthWedding_delete, label: "Admin: Delete Invitation" },
      { url: img_johnRuthWedding_import, label: "Admin: Import using CSV" },
      { url: img_johnRuthWedding_batchDelete, label: "Admin: Batch Delete" },
      { url: img_johnRuthWedding_settings, label: "Admin: Event Settings" },
      {
        url: img_johnRuthWedding_howToVerify,
        label: "QR Verification: How To",
      },
      {
        url: img_johnRuthWedding_verification,
        label: "QR Verification: Invite Status",
      },
      { url: img_johnRuthWedding_map, label: "Embedded Map" },
    ],
  },
  ...
  // Bytes of Past
  {
    ...
    links: [
      {
        site: "download",
        url: "https://github.com/christiankyle-ching/Prototype--Bytes-of-Past/releases",
      },
      {
        site: "github",
        url: "https://github.com/christiankyle-ching/Prototype--Bytes-of-Past",
      },
    ],
    media: [
      { url: img_bytesOfPast_logo },
      { url: img_bytesOfPast_main_menu, label: "Main Menu" },
      { url: img_bytesOfPast_settings, label: "Settings" },
      {
        url: img_bytesOfPast_topics,
        label: "Choose from 3 ICT History Topics",
      },
      {
        url: img_bytesOfPast_difficulty,
        label: "Choose from 3 levels of difficulty (Single Player)",
      },
      {
        url: img_bytesOfPast_tutorial,
        label: "Use the tutorial mode to learn the game!",
      },
      {
        url: img_bytesOfPast_single_player,
        label: "Order the inventions by their year",
      },
      {
        url: img_bytesOfPast_join,
        label: "Join with other players via LAN (same WiFi)",
      },
      {
        url: img_bytesOfPast_multiplayer,
        label: "Beat your friends in Multiplayer!",
      },
      {
        url: img_bytesOfPast_profile,
        label: "Check your progress and stats, share it too!",
      },
      {
        url: img_bytesOfPast_achievements,
        label: "Can you obtain all the achievements?",
      },
      {
        url: img_bytesOfPast_assessment,
        label: "Assess yourself before and after playing to see if you learned",
      },
    ],
  },
  ...
  // Digital Wellbeing for Windows
  {
    ...
    links: [
      {
        site: "download",
        url: "https://github.com/christiankyle-ching/DigitalWellbeingForWindows/releases",
      },
      {
        site: "github",
        url: "https://github.com/christiankyle-ching/DigitalWellbeingForWindows",
      },
    ],
    media: [
      {
        url: img_digitalWellbeingWindows_logo,
        label: "Digital Wellbeing For Windows",
      },
      {
        url: img_digitalWellbeingWindows_home,
        label: "View your today and your past 7 days usage data",
      },
      {
        url: img_digitalWellbeingWindows_chart,
        label: "Pie Chart view of your app usage",
      },
      {
        url: img_digitalWellbeingWindows_list,
        label: "List view of your app usage",
      },
      {
        url: img_digitalWellbeingWindows_settings,
        label: "Adjust settings to your needs",
      },
    ],
    features: [
  ...
  // FOMO Reservation
  {
    ...
    links: [
      { site: "open", url: "https://fomo-reservation.netlify.app/" },
      {
        site: "github",
        url: "https://github.com/christiankyle-ching/FOMO-Reservation",
        label: "Github (Front-End Vue.JS 3)",
      },
      {
        site: "github",
        url: "https://github.com/christiankyle-ching/FOMO-Reservation",
        label: "Github (Serverless Functions)",
      },
    ],
    media: [
      { url: img_fomo_limited_reservation, label: "Limited Reservation" },
      {
        url: img_fomo_early_order,
        label: "Be able to order when you're early",
      },
      {
        url: img_fomo_variantsAddons,
        label: "Products can have variants and/or add-ons",
      },
      { url: img_fomo_payment, label: "Payment options available" },
      {
        url: img_fomo_past_orders,
        label: "View your past orders (with receipts)",
      },
      { url: img_fomo_profile, label: "Update your Profile for easy contact" },
      { url: img_fomo_manage_products, label: "Admin: Manage Products" },
      {
        url: img_fomo_excel_template,
        label: "Admin: Use an Excel template to manage products easily",
      },
      { url: img_fomo_batch_history, label: "Admin: View past batches" },
      { url: img_fomo_manage_admins, label: "Super Admin: Manage your Admins" },
    ],
  },
  ...
  // NASA APOD
  {
    ...
    links: [
      {
        site: "download",
        url: "https://github.com/christiankyle-ching/nasa-apod/releases",
      },
      {
        site: "github",
        url: "https://github.com/christiankyle-ching/nasa-apod/",
      },
    ],
    media: [
      { url: img_nasaApod_logo, label: "NASA's APOD" },
      { url: img_nasaApod_recents, label: "Browse the APOD Gallery" },
      { url: img_nasaApod_settings, label: "Enable daily changing wallpaper" },
      {
        url: img_nasaApod_detail,
        label: "View and read about each photo's background",
      },
      { url: img_nasaApod_date, label: "Seek a memorable date" },
      {
        url: img_nasaApod_favorites,
        label: "Give a star to your favorite dates",
      },
      { url: img_nasaApod_share, label: "Share what you found" },
      {
        url: img_nasaApod_wallpaper,
  ...
  // RoomFiles
  {
    ...
    media: [
      { url: img_roomfiles_logo, label: "RoomFiles" },
      {
        url: img_roomfiles_room,
        label: "Create a room with your friends / colleagues!",
      },
      {
        url: img_roomfiles_rooms,
        label: "Join / Create multiple rooms for your needs",
      },
      { url: img_roomfiles_files, label: "Store and share your lesson files" },
      {
        url: img_roomfiles_announcements,
        label: "Make announcements for everyone to see",
      },
      {
        url: img_roomfiles_notifications,
        label: "Get notified on recent activities",
      },
      { url: img_roomfiles_people, label: "Manage people in your room" },
    ],
    links: [
      { site: "open", url: "https://roomfiles.herokuapp.com/" },
      {
        site: "github",
  ...
  // Budget Planner
  {
    ...
    links: [
      {
        site: "download",
        url: "https://github.com/christiankyle-ching/budgetPlanner/releases/",
      },
      {
        site: "github",
    ...
    media: [
      ...
      { url: img_budget_dark, label: "Supports dark mode" },
      { url: img_budget_summary, label: "Generate montly overview" },
      { url: img_budget_toplist, label: "View your expenses" },
      { url: img_budget_savings, label: "Track your savings" },
      { url: img_budget_help, label: "Never feel clueless! I'm here." },
      { url: img_budget_backup, label: "Even supports local backup!" },
    ],
  },
  ...
  // Edzer Recording DBMS
  {
    ...
    media: [
      { url: img_edzer_logo, label: "A Recording Studio Scheduling System" },
      { url: img_edzer_login, label: "Login" },
      { url: img_edzer_dashboard, label: "Dashboard Overview" },
      { url: img_edzer_add, label: "Add Schedules" },
      { url: img_edzer_schedules, label: "Be reminded of who's next" },
      { url: img_edzer_instruments, label: "Manage Instruments" },
    ],
    links: [
      {
        site: "github",
        url: "https://github.com/christiankyle-ching/EdzerSchedulingSystem",
      },
    ],
    features: [
...
PROJECTS.sort((a, b) => b.date_dev.getTime() - a.date_dev.getTime());

const ACTIVE_PROJECTS = PROJECTS.filter((p) => !p.disabled);
